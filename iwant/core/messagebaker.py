...
class Basemessage(object):
    def __init__(self, key=None, data=None, message=None):
        ...
        self.DELIMITERS_PARAMS = [FILE, LIST_ALL_FILES, ERROR_LIST_ALL_FILES, LEADER, HASH_DUMP, FILE_SYS_EVENT, SEARCH_REQ, SEARCH_RES, LOOKUP, IWANT_PEER_FILE, PEER_LOOKUP_RESPONSE, SEND_PEER_DETAILS, FILE_DETAILS_RESP, INIT_FILE_REQ, IWANT, FILE_TO_BE_DOWNLOADED, START_TRANSFER, PEER_DEAD, REQ_CHUNK, INDEXED, FILE_CONFIRMATION_MESSAGE, INTERESTED]
        self._delimiter = ';'
        self._EOL = '\r'
