...
class Basemessage(object):
    def __init__(self, key=None, data=None, message=None):
        self.NO_PARAM = [HANDSHAKE, LEADER_NOT_READY, END_GAME]
        self.DELIMITERS_PARAMS = [FILE, LIST_ALL_FILES, ERROR_LIST_ALL_FILES, LEADER, HASH_DUMP, FILE_SYS_EVENT, SEARCH_REQ, SEARCH_RES, LOOKUP, IWANT_PEER_FILE, PEER_LOOKUP_RESPONSE, SEND_PEER_DETAILS, FILE_DETAILS_RESP, INIT_FILE_REQ, IWANT, FILE_TO_BE_DOWNLOADED, START_TRANSFER, DEAD, REQ_CHUNK, INDEXED]
        self._delimiter = ';'
        self._EOL = '\r'
